package com.ecolix.atschool.ui.students.models
    ...
    companion object {
        fun sample(isDarkMode: Boolean): StudentsUiState {
            ...
            return StudentsUiState(
                ...
                classrooms = listOf(
                    Classroom("C1", "6e A", 42, 22, 20, "College", year),
                    Classroom("C2", "6e B", 40, 20, 20, "College", year),
                    Classroom("C3", "5e A", 38, 18, 20, "College", year),
                    Classroom("C4", "Terminale S", 32, 16, 16, "Lycee", year)
                )
            )
        }
    }
